...
#  *****  UAC call scenario execution using sipp *****
			...
			call = '/root/testing/sipp-3.4-beta2/sipp -sf /root/testing/automation/xmlscenarios/uac_ulaw_ip_to_ip_call.xml $ip1 -i $ip2 -r 1 -m 1 -s 3003 -ap 3003 -mp 6009'
...
#  ********  Comparing captured wav file with the Original file using PESQ tool to evaluate voice quality  ***********
			...
			r = subprocess.Popen('/root/testing/PESQ/P862_annex_A_2005_CD/source/PESQ +8000 /root/testing/automation/sounds/sourceulaw.wav /root/testing/automation/sounds/capture3D.wav', shell=True)
